...
def gendata(fp):
    ...
    with open("C:\\Users\\nakshita\\RML2016.10a_dict.pkl", "rb") as fp:
        Xd = pickle.load(fp, encoding='latin1')
...
def FeatureReverse(a,step):
    ...
    return ab
xtrain1, xtest1, ytrain1, ytest1 = gendata("‪C:\\Users\\nakshita\\RML2016.10a_dict.pkl")
Rstep = 4
...
adam0 = tf.optimizers.Adam(learning_rate=0.0005)
